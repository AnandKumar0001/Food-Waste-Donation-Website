  ...
  <table class="table ">
    <thead>
      <tr>
        ...
        <th class="text-center">Organistation Name</th>
        <th class="text-center">Date&nbsp&nbsp&nbsp&nbsp&nbsp</th>
        <th class="text-center">Time</th>
        <th class="text-center">&nbsp&nbsp&nbsp&nbsp</th>
    ...
    <tr>
      ...
      <td><button class="btn btn-success" style="height:40px" onclick="Approvefood('<?=$row['id']?>')">✓</button></td>
      <td><button class="btn btn-danger" style="height:40px" onclick="foodDelete('<?=$row['id']?>')">X</button></td>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">New Food Request</h4>
