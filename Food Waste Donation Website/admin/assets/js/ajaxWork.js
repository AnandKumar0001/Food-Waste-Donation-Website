...
//edit Agent Details
function agentEditForm(id){
    $.ajax({
        url:"./adminView/editAgentForm.php",
        method:"post",
        data:{record:id},
        success:function(data){
            $('.allContent-section').html(data);
...
//update Agent after submit
function updateItems(){
    var product_id = $('#id').val();
    var p_name = $('#name').val();
    var p_desc = $('#email').val();
    var p_price = $('#password').val();
    var category = $('#mob').val();
    //var existingImage = $('#existingImage').val();
    //var newImage = $('#newImage')[0].files[0];
    var fd = new FormData();
    fd.append('id', product_id);
    fd.append('name', p_name);
    fd.append('email', p_desc);
    fd.append('password', p_price);
    fd.append('mobile', category);
    //fd.append('existingImage', existingImage);
    //fd.append('newImage', newImage);
   
    $.ajax({
      url:'./controller/updateAgentController.php',
      method:'post',
      data:fd,
      processData: false,
      contentType: false,
...
function deletedonor(id){
    $.ajax({
        url:"./controller/deletedonorController.php",
        method:"post",
        data:{record:id},
        success:function(data){
           alert('hey');
