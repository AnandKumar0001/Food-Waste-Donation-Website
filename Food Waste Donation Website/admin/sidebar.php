...
<hr style="border:1px solid; background-color:#8a7b6d; border-color:#3B3131;">
    ...
    <a href="#customers"  onclick="showCustomers()" ><i class="fa fa-users"></i> Donor's Details</a>
    <a href="#category"   onclick="showCategory()" ><i class="fa fa-th-large"></i> Agent's Detail</a>
    ...
    <a href="#orders" onclick="showOrders()"><i class="fa fa-list"></i> Messages</a>
     <a href="../a2d.php"><i class="fa fa-list"></i> Send Message To Donor</a>
       <a href="..\a2ag.php"><i class="fa fa-list"></i> Send Message To Agent</a>
