...
if (isset($_POST["Submit"])) {
  ...
  $check_otp = mysqli_num_rows(mysqli_query($conn, "SELECT token FROM login WHERE token='$otpf'"));
  ...
  $update = mysqli_query($conn, "UPDATE login SET status='1' WHERE token='$otpf'");
