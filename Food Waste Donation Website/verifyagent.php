...
if (isset($_POST["Submit"])) {
  ...
  $check_otp = mysqli_num_rows(mysqli_query($conn, "SELECT token FROM agentlogin WHERE token='$otpf'"));
  ...
  $update = mysqli_query($conn, "UPDATE agentlogin SET status='1' WHERE token='$otpf'");
...
<head>
  ...
  <title>Agent Singin And Singup</title>
</head>
